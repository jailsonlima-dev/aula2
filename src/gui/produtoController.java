...
public class produtoController extends FormularioController {
	...
	@FXML
	protected TextField txtEstoque;
	@FXML
	protected TextField txtNome;
	@FXML
	protected TextField txtPreco;
	@FXML
	protected TextField txtcodBarra;

	@FXML
	protected TableView<produtoModel> tabDados;
	@FXML
	protected TableColumn<produtoModel, Integer> colID;
	@FXML
	protected TableColumn<produtoModel, String> colDescricao;
	...
	public void initialize() {
		...
		/*
		 * colID.setCellValueFactory(data-> new
		 * javafx.beans.property.SimpleIntegerProperty(
		 * data.getValue().getID()).asObject()); colDescricao.setCellValueFactory(data->
	...
	protected void Salvar() {
		...
		try {
			...
			if (statusForm == 1) {
				...
				produtoModel atualizaProduto = new produtoModel(id, nome, descricao, codbarras, preco, estoque, null,
						null);
