...
public class clienteController extends FormularioController {
	...
	public void initialize() {
		...
		colID.setCellValueFactory(
				data -> new javafx.beans.property.SimpleIntegerProperty(data.getValue().getIdCliente()).asObject());
	...
	protected void Salvar() {
		...
		try {
			...
			if (statusForm == 1) {
				...
				clienteModel atualizaCliente = new clienteModel(id, nome, cpf, telefone, email, null, null);
